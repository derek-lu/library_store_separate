...
/**
 * Start a Folio Info transaction without setting direct entitlement. This API will only
 * return folio information if the 'Custom library or store manages issues' setting
...
/**
 * Start a Folio Info transaction with setting direct entitlement. This API will only
 * return folio information if the 'Custom library or store manages issues'
 * setting is enabled in App Builder. Entitlement will only be added to the folio 
 * if the user is signed in and folio is not free or not entitled;
